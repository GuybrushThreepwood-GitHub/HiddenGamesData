...
local levelSetup = 
{
	...
	levelModel = 20004;
	-- physics data
	levelPhysicsComplex = "assets/levels/4/collision.ode";
	-- data
	levelData = "assets/levels/4/level_data.dat";
	...
	allowRain 					= true;
	rainProbability				= 5; -- 0 (low) 10 (high)
	...
	coverage 					= "assets/levels/4/spritemap.png";
