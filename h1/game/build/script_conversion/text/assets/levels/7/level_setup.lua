...
local levelSetup = 
{
	...
	levelModel = 20007;
	-- physics data
	levelPhysicsComplex = "assets/levels/7/collision.ode";
	-- data
	levelData = "assets/levels/7/level_data.dat";
	...
	allowRain 					= true;
	rainProbability				= 8; -- 0 (low) 10 (high)
	...
	coverage 					= "assets/levels/7/spritemap.png";
