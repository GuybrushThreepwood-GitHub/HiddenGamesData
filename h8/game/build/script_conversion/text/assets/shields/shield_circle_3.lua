...
function shield_circle_3( posX, posY )
	...
	local body2Def = 
	{
		...
		positionY = posY;
		gravityScale = 0.0;
		numeric1 = 203;			-- hgm lookup (see model_resources.lua)
	...
	CreatePolygonShape( body2Ptr, circle3_tri_1 )
	CreatePolygonShape( body2Ptr, circle3_tri_2 )
	CreatePolygonShape( body2Ptr, circle3_tri_3 )
