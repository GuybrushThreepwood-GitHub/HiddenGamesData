...
function shield_octagon_2( posX, posY )
	...
	local body2Def = 
	{
		...
		positionY = posY;
		gravityScale = 0.0;
		numeric1 = 602;			-- hgm lookup (see model_resources.lua)
	...
	CreatePolygonShape( body2Ptr, octagon2_tri_1 )
	CreatePolygonShape( body2Ptr, octagon2_tri_2 )
