...
function shield_circle_2( posX, posY )
	...
	local body2Def = 
	{
		...
		positionY = posY;
		gravityScale = 0.0;
		numeric1 = 202;			-- hgm lookup (see model_resources.lua)
	...
	CreatePolygonShape( body2Ptr, circle2_tri_1 )
	CreatePolygonShape( body2Ptr, circle2_tri_2 )
