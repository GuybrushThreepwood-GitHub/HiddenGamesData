...
function shield_hexagon_3( posX, posY )
	...
	local body2Def = 
	{
		...
		positionY = posY;
		gravityScale = 0.0;
		numeric1 = 503;			-- hgm lookup (see model_resources.lua)
	...
	CreatePolygonShape( body2Ptr, hexagon3_tri_1 )
	CreatePolygonShape( body2Ptr, hexagon3_tri_2 )
	CreatePolygonShape( body2Ptr, hexagon3_tri_3 )
