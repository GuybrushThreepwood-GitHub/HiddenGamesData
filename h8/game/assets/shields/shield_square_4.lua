...
function shield_square_4( posX, posY )
	...
	local body2Def = 
	{
		...
		positionY = posY;
		gravityScale = 0.0;
		numeric1 = 404;			-- hgm lookup (see model_resources.lua)
	...
	CreatePolygonShape( body2Ptr, square4_tri_1 )
	CreatePolygonShape( body2Ptr, square4_tri_2 )
    CreatePolygonShape( body2Ptr, square4_tri_3 )
	CreatePolygonShape( body2Ptr, square4_tri_4 )
