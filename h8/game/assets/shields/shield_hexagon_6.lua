...
function shield_hexagon_6( posX, posY )
	...
	local body2Def = 
	{
		...
		positionY = posY;
		gravityScale = 0.0;
		numeric1 = 506;			-- hgm lookup (see model_resources.lua)
	...
	CreatePolygonShape( body2Ptr, hexagon6_tri_1 )
	CreatePolygonShape( body2Ptr, hexagon6_tri_2 )
	CreatePolygonShape( body2Ptr, hexagon6_tri_3 )
    CreatePolygonShape( body2Ptr, hexagon6_tri_4 )
	CreatePolygonShape( body2Ptr, hexagon6_tri_5 )
	CreatePolygonShape( body2Ptr, hexagon6_tri_6 )
