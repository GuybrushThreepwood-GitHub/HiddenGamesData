...
local levelSetup = 
{
	levelName = 215; -- string res
	
	-- level models
	levelModel = 10015;
	-- background model
	levelBackground = 20015;
	-- foreground model
	levelForeground = 30015;
	-- physics data
	levelPhysicsComplex = "assets/levels/4_1_dogseyeschief/physics.b2d";
	-- data
	levelData = "assets/levels/4_1_dogseyeschief/leveldata.dat";
