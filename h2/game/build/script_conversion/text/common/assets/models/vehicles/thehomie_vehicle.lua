...
{
	bodyPtr = 0;
	landingGearShapeTable = "thehomie_landingGearBody";
	...
	movementForceVac = 80.0; -- left/right force
	
	upwardsForceWater = 50.0; -- up force
	movementForceWater = 80.0; -- left/right force
	...
	burnersVerticalFrontOffsetX = -1.223;
	burnersVerticalFrontOffsetY = -0.895;
	burnersVerticalBackOffsetX = 0.693;
	burnersVerticalBackOffsetY = -0.895;
	
	burnersHorizontalMesh = -1;
	burnersHorizontalEmitterId = HORIZONTAL_THRUSTERS_EMITTER_ID;
	brunersHorizontalOffsetX = 1.500;
	brunersHorizontalOffsetY = -0.895;
...
function thehomie_Definition()

	LoadScript( "assets/models/vehicles/thehomie_physsetup.lua" )
	VehicleDefinition.bodyPtr = thehomie_PhysicsSetup()
