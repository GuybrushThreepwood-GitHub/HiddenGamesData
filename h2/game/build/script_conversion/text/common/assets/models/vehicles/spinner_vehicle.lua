...
{
	bodyPtr = 0;
	landingGearShapeTable = "spinner_landingGearBody";
	...
	burnersVerticalFrontOffsetX = -1.724;
	burnersVerticalFrontOffsetY = -0.604;
	burnersVerticalBackOffsetX = 1.277;
	burnersVerticalBackOffsetY = -0.703;
	
	burnersHorizontalMesh = -1;
	burnersHorizontalEmitterId = HORIZONTAL_THRUSTERS_EMITTER_ID;
	brunersHorizontalOffsetX = 2.058;
	brunersHorizontalOffsetY = -0.297;
...
function spinner_Definition()

	LoadScript( "assets/models/vehicles/spinner_physsetup.lua" )
	VehicleDefinition.bodyPtr = spinner_PhysicsSetup()
