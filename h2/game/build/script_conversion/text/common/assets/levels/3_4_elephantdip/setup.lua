...
local levelSetup = 
{
	levelName = 213; -- string res
	
	-- level models
	levelModel = 10013;
	-- background model
	levelBackground = 20013;
	-- foreground model
	levelForeground = 30013;	
	-- physics data
	levelPhysicsComplex = "assets/levels/3_4_elephantdip/physics.b2d";
	-- data
	levelData = "assets/levels/3_4_elephantdip/leveldata.dat";
	...
	levelBGPosY					= 150;--gameData.BG_POS_Y_DEFAULT;
