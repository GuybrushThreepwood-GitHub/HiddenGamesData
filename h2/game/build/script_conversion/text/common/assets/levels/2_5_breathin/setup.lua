...
local levelSetup = 
{
	levelName = 209; -- string res
	
	-- level models
	levelModel = 10009;
	-- background model
	levelBackground = 20009;
	-- foreground model
	levelForeground = -1;
	-- physics data
	levelPhysicsComplex = "assets/levels/2_5_breathin/physics.b2d";
	-- data
	levelData = "assets/levels/2_5_breathin/leveldata.dat";
	...
	levelAfternoonLight 	= "afternoonLevelSettings_Cold";
