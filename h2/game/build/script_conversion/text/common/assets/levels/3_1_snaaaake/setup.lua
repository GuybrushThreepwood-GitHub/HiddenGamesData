...
local levelSetup = 
{
	levelName = 210; -- string res
	
	-- level models
	levelModel = 10010;
	-- background model
	levelBackground = 20010;
	-- foreground model
	levelForeground = -1;
	-- physics data
	levelPhysicsComplex = "assets/levels/3_1_snaaaake/physics.b2d";
	-- data
	levelData = "assets/levels/3_1_snaaaake/leveldata.dat";
