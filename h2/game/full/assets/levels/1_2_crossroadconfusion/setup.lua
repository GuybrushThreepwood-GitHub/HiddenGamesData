...
local levelSetup = 
{
	...
	levelModel = 10001;
	-- background model
	levelBackground = 20001;
	-- foreground model
	levelForeground = 30001;
	-- physics data
	levelPhysicsComplex = "assets/levels/1_2_crossroadconfusion/physics.b2d";
	-- data
	levelData = "assets/levels/1_2_crossroadconfusion/leveldata.dat";
...
function Load_crossroadconfusion()
