...
local levelSetup = 
{
	levelName = 204; -- string res
	
	-- level models
	levelModel = 10004;
	-- background model
	levelBackground = 20004;
	-- foreground model
	levelForeground = 30004;
	-- physics data
	levelPhysicsComplex = "assets/levels/1_5_asteroids/physics.b2d";
	-- data
	levelData = "assets/levels/1_5_asteroids/leveldata.dat";
	...
	levelBGWidth				= 500;--gameData.BG_QUAD_WIDTH;
	levelBGHeight				= 500;--gameData.BG_QUAD_HEIGHT;
