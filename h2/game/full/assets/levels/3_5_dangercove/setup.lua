...
local levelSetup = 
{
	levelName = 214; -- string res
	
	-- level models
	levelModel = 10014;
	-- background model
	levelBackground = 20014;
	-- foreground model
	levelForeground = 30014;
	-- physics data
	levelPhysicsComplex = "assets/levels/3_5_dangercove/physics.b2d";
	-- data
	levelData = "assets/levels/3_5_dangercove/leveldata.dat";
	...
	levelBGWidth				= 225;--gameData.BG_QUAD_WIDTH;
	levelBGHeight				= 225;--gameData.BG_QUAD_HEIGHT;
