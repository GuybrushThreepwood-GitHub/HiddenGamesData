...
local levelSetup = 
{
	levelName = 212; -- string res
	
	-- level models
	levelModel = 10012;
	-- background model
	levelBackground = 20012;
	-- foreground model
	levelForeground = 30012;
	-- physics data
	levelPhysicsComplex = "assets/levels/3_3_meteorshower/physics.b2d";
	-- data
	levelData = "assets/levels/3_3_meteorshower/leveldata.dat";
