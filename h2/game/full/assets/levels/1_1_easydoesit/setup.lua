...
local levelSetup = 
{
	levelName = 200; -- string res
    
	-- level models
	levelModel = 10000;
	-- background model
	levelBackground = 20000;
	-- foreground model
	levelForeground = 30000;
	-- physics data
	levelPhysicsComplex = "assets/levels/1_1_easydoesit/physics.b2d";
	-- data
	levelData = "assets/levels/1_1_easydoesit/leveldata.dat";
