...
{
	bodyPtr = 0;
	landingGearShapeTable = "flyingbeetle_landingGearBody";
	...
	movementForceAir = 40.0; -- left/right force		
			
	upwardsForceVac = 40.0; -- up force
	movementForceVac = 30.0; -- left/right force
	
	upwardsForceWater = 40.0; -- up force
	movementForceWater = 35.0; -- left/right force
	...
	burnersVerticalFrontOffsetX = -1.117;
	burnersVerticalFrontOffsetY = -0.560;
	burnersVerticalBackOffsetX = 0.931;
	burnersVerticalBackOffsetY = -0.583;
	
	burnersHorizontalMesh = -1;
	burnersHorizontalEmitterId = HORIZONTAL_THRUSTERS_EMITTER_ID;
	brunersHorizontalOffsetX = 1.696;
	brunersHorizontalOffsetY = -0.404;
...
function flyingbeetle_Definition()

	LoadScript( "assets/models/vehicles/flyingbeetle_physsetup.lua" )
	VehicleDefinition.bodyPtr = flyingbeetle_PhysicsSetup()
